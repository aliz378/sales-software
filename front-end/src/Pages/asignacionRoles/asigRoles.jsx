                ...
                <div className="contact_form">
                    <div className="formulario">
                        <form id="form-gestion-usuarios" method="get" autocomplete="off">
                            <p className="p-users">
                                <label for="ID de usuario" className="labelGU">ID del usuario
                            ...
                            <p className="p-users">
                                <label for="ID del usuario" className="labelGU">Nombre del usuario
                                    <span className="obligatorio">*</span>
                                </label>
                                <input type="text" name="introducir_nombre" id="nombre" required="obligatorio"
                            ...
                            <p className="p-users">
                                <label for="Nombre del usuario" className="labelGU">Teléfono del usuario
                                    <span className="obligatorio">*</span>
                                </label>
                                <input type="text" name="introducir_nombre" id="nombre" required="obligatorio"
                            ...
                            <div className="form-check form-check-inline">
                                ...
                                <label className="form-check-label" for="inlineCheckbox1">Vendedor</label>
                            </div>
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2" />
                                <label className="form-check-label" for="inlineCheckbox2">Administrador</label>
                            </div>
                            <br />
                            <br />
